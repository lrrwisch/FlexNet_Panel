        ...
        <div className="relative bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden">
          <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6 flex items-center justify-between z-10">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-2xl font-bold text-white">Gönderi Detayları</h2>
            </div>
            <button
              onClick={onClose}
            ...
            {loading ? (
              <div className="flex items-center justify-center py-16">
                <div className="text-center">
                  ...
                  <p className="mt-6 text-gray-600 font-medium">Gönderi detayları yükleniyor...</p>
                </div>
              </div>
            ) : error ? (
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                  ...
                  <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                      <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Sipariş Kodu</label>
                      <p className="text-base text-gray-900 font-bold">{shipment.orderCode}</p>
                    </div>
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                      <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Flex Kodu</label>
                      <p className="text-base text-gray-900 font-bold">{shipment.flexCode}</p>
                    </div>
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                      <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Müşteri</label>
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                      <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Takip Numarası</label>
                      <p className="text-base text-gray-900 font-mono font-semibold">{shipment.waybill || '-'}</p>
                    </div>
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                      <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Kargo Şirketi</label>
                      <p className="text-base text-gray-900 font-semibold">{shipment.shipCompany || '-'}</p>
                    </div>
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                      <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Oluşturulma Tarihi</label>
                    ...
                    {shipment.labelDate && (
                      <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Etiket Oluşturma Tarihi</label>
                        <p className="text-sm text-gray-900 font-medium">
                ...
                {shipment.receiverName && (
                  <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                    ...
                    <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Telefon</label>
                      ...
                      <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Şehir</label>
                        <p className="text-base text-gray-900 font-semibold">{shipment.receiverCity || '-'}</p>
                      </div>
                      <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Eyalet/Bölge</label>
                  ...
                  <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                    ...
                    <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                      {shipment.packageDescription && (
                        <div className="md:col-span-2 bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                          <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Ürün Açıklaması</label>
                          <p className="text-sm text-gray-900 leading-relaxed">{shipment.packageDescription}</p>
                        </div>
                      )}
                      {shipment.productQuantity && (
                        <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                          <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Miktar</label>
                      ...
                      {shipment.productPrice && (
                        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200">
                          <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Ürün Fiyatı</label>
                          <p className="text-xl text-green-600 font-bold">${shipment.productPrice.toFixed(2)}</p>
                        </div>
                      )}
                      {shipment.packageWeight && (
                        <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                          <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Ağırlık</label>
                      ...
                      {shipment.packageLength && (
                        <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
                          <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Boyutlar (U × G × Y)</label>
                    ...
                    <div className="px-6 py-5">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-500 font-medium">Toplam kargo ücreti</p>
                        </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div className="ml-4 flex-1 bg-gradient-to-br from-blue-50 to-white rounded-lg p-4 border border-blue-200">
                          <p className="text-sm font-bold text-gray-900">Sipariş Oluşturuldu</p>
                      ...
                      {shipment.isCreatedLabel && shipment.labelDate && (
                        <div className="flex items-start">
                          ...
                          <div className="ml-4 flex-1 bg-gradient-to-br from-green-50 to-white rounded-lg p-4 border border-green-200">
                            <p className="text-sm font-bold text-gray-900">Etiket Oluşturuldu</p>
                      ...
                      {shipment.isShipped && shipment.shippedDate && (
                        <div className="flex items-start">
                          ...
                          <div className="ml-4 flex-1 bg-gradient-to-br from-teal-50 to-white rounded-lg p-4 border border-teal-200">
                            <p className="text-sm font-bold text-gray-900">Gönderildi</p>
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-500 font-medium">Gönderi verisi bulunamadı</p>
              </div>
            )}
          </div>
